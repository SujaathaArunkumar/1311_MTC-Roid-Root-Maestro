		...
		mBusNumbers.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (source != destinatn) {
					...
					Intent mIntent = new Intent(SearchActivity.this,BusNumberActivity.class);
					...
					if (status.equals("Success")) {
						...
						if (nodesSize > 0) {
							...
							for (int i = 0; i < nodesSize; i++) {
								...
								String source = (XMLfunctions.getValue(e,"Source"));								
								mSource[i]=source;							
							}
						}
						arrayAdapter = new ArrayAdapter<String>(SearchActivity.this,android.R.layout.simple_spinner_item, mSource);
